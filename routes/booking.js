...
// // http://localhost:9000/api/booking/:eventId
// router.put("/event/:eventId", adminMiddleware, allBookingsFromEvents)

// // http://localhost:9000/api/booking/:eventId
// router.put("/:bookingId", userMiddleware, getBookTicketByUser)
